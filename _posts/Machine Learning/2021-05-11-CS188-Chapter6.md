...
Each constraint can be represented in two parameters - the $scope$ and the $relation$. The $scope$ define the variables that are related with this constraint. The $relation$ define the values that variables can take.
